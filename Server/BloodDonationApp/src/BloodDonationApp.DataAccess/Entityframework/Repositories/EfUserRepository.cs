...
public class EfUserRepository : EfEntityRepositoryBase<User, BloodDonationAppContext>, IUserRepository
{
    public EfUserRepository(BloodDonationAppContext context) : base(context)
    {
    }
}
